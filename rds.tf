...
resource "aws_db_instance" "fiap-db-pagamento" {
  allocated_storage      = 20 # Tamanho em GB
  storage_type           = "gp2"
  engine                 = "postgres"
  engine_version         = "12.16"
  instance_class         = "db.t2.micro"     # Tipo de instância
  identifier             = "fiap-db-pedido"      # Identificador da instância RDS
  name                   = "fiapPedido"            # Nome da base de dados dentro da instância
